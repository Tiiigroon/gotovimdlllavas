...
const translations: Translations = {
  ...
  "hero.subtitle": { ru: "Готовлю для вас из свежих продуктов по домашним рецептам", en: "I cook for you using fresh ingredients and homemade recipes" },
  ...
  "about.p1": { ru: "«Готовлю Для Вас» — это домашняя еда приготовленная с душой. Мы верим, что вкусная еда объединяет людей.", en: "\"Cooking For You\" is homemade food prepared with heart. We believe delicious food brings people together." },
  "about.p2": { ru: "Каждое блюдо готовлю из свежих и натуральных продуктов, используя проверенные домашние рецепты. ", en: "Every dish is made from fresh, natural ingredients using tried-and-true homemade recipes." },
  "about.p3": { ru: "Мы доставляем по всему Минску, Дзержинску и Фаниполю, чтобы вы могли насладиться вкусом домашней еды, не выходя из дома.", en: "We deliver across Minsk, Dzerzhinsk, and Fanipol so you can enjoy homemade food without leaving your home." },
  ...
  "form.minOrder": { ru: "Минимальная сумма заказа — 100 BYN", en: "Minimum order amount is 100 BYN" },
